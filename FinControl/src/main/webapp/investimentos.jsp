...
<body>
    ...
    <div class="container">
        ...
        <form action="InvestimentosServlet" method="post" class="mt-5">
        <input type="hidden" name="acao" value="cadastrar"/>
		  ...
		  <div class="mb-3">
		    <label for="id-data" class="form-label">Data do Investimento:</label>
		  ...
		  <input class="btn btn-success" type="submit" value="Cadastrar novo Investimento">
		</form>
		...
		<table class="table table-striped mt-5">
			...
			<c:forEach items="${investimentos}" var="i">
				<tr>
					...
					<td>${i.valor}</td>
					<td>
						<fmt:formatDate value="${i.dtInvestimento.time}" pattern="dd/MM/yyyy"/>
					</td>
					<td>
						<c:url value="InvestimentosServlet" var="link">
						...
						onclick="codigoExcluir.value = ${i.codigo}; codigoUsuario.value = ${i.cdUsuario}">Excluir</button>
					</td>
				</tr>
			</c:forEach>
		</table>
