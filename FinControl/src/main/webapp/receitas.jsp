...
<body>
    ...
    <div class="container">
        ...
        <form action="ReceitasServlet" method="post" class="mt-5">
		...
		<table class="table table-striped mt-5">
			...
			<c:forEach items="${receitas}" var="r">
				<tr>
					...
					<td>
						<c:url value="ReceitasServlet" var="link">
						...
						onclick="codigoExcluir.value = ${r.codigo}; codigoUsuario.value = ${r.cdUsuario}">Excluir</button>
					</td>
				</tr>
			</c:forEach>
		</table>
